...
def transducer_calibration_loop_6q() -> str:
    """6-qubit transducer calibration loop with repeated seam-sensitive phases."""
    return """\
OPENQASM 2.0;
include "qelib1.inc";
qreg q[6];
...
def logical_patch_handoff_10q() -> str:
    """10-qubit logical-patch handoff surrogate across a modular bus."""
    return """\
OPENQASM 2.0;
include "qelib1.inc";
qreg q[10];
...
def optical_coupling_probe_6q() -> str:
    """6-qubit probe for optical-coupling sensitivity across a chained seam."""
    return """\
OPENQASM 2.0;
include "qelib1.inc";
qreg q[6];
...
def heralding_window_probe_6q() -> str:
    """6-qubit heralding-window probe with repeated seam handoff structure."""
    return """\
OPENQASM 2.0;
include "qelib1.inc";
qreg q[6];
...
def detector_correlation_probe_6q() -> str:
    """6-qubit detector-correlation probe for receive-side closure pressure."""
    return """\
OPENQASM 2.0;
include "qelib1.inc";
qreg q[6];
...
def phase_lock_window_probe_6q() -> str:
    """6-qubit phase-lock probe with repeated phase-sensitive seam usage."""
    return """\
OPENQASM 2.0;
include "qelib1.inc";
qreg q[6];
